...
<html lang="en">
  <head>
    ...
    <style>
      ...
      /* Additional styles for cell block list */
      table {
        width: 100%;
    ...
    <div class="container">
      <div class="sidebar">
        <div class="sidebar-logo">
          <img
            src="https://w7.pngwing.com/pngs/582/828/png-transparent-prison-cell-prisoners-rights-bail-bondsman-prison-miscellaneous-text-logo-thumbnail.png"
            alt="PMS Logo"
          />
      ...
      <div class="content">
        ...
        <main>
          <div class="header-controls">
            <h1>Cell Block List</h1>
            
      
            <a href="cellblockform.html" class="create-new-button" style="text-decoration: none;">Create New</a>
          </div>
          <table>
            
          <?php   

            include 'cellblockconnect.php'; ?>
          </table>
        </main>
      </div>
    </div>
